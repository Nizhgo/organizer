...
const CalendarItem = memo((props: IDayElement) => {
	...
	return (
		<DayElementWrapper key={date.getTime()} onClick={onSelect} isSelected={isSelected}
			...
			<TasksContainer>
				...
				{taskCount > 2 &&
					<TaskTitle style={{fontSize: '8px', textDecoration: 'underline'}}> И еще {taskCount - 2}... </TaskTitle>
					}
			</TasksContainer>
		</DayElementWrapper>
	)
